...
class Ticket(BaseModel):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tickets', verbose_name=_('User (Requester)'))
    title = models.CharField(_('Title'), max_length=250)
    ticket_type = models.ForeignKey(TicketType, on_delete=models.SET_NULL, null=True, related_name='tickets', verbose_name=_('Ticket Type'))
    priority = models.CharField(_('Priority'), max_length=30, choices=Priority.choices, default=Priority.MEDIUM, db_index=True)
    status = models.CharField(_('Status'), max_length=30, choices=Status.choices, default=Status.OPEN, db_index=True)
...
class Attachment(BaseModel):
    message = models.ForeignKey(Message, on_delete=models.CASCADE, related_name='attachments', verbose_name=_('Message'))
